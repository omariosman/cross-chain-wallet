...
import { DeployUtil, CLPublicKey, CLValue } from '..';
...
export declare class CasperServiceByJsonRPC {
     ...
     */
    deploy(signedDeploy: DeployUtil.Deploy): Promise<DeployResult>;
    /**
     ...
     */
    waitForDeploy(signedDeploy: DeployUtil.Deploy, timeout?: number): Promise<GetDeployResult>;
